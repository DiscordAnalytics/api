...
impl BotStats {
    pub fn with_added_guilds(mut self, added_guilds: i32) -> Self {
        self.added_guilds = added_guilds;
        self
    }
    ...
    pub fn with_custom_events(mut self, custom_events: HashMap<String, i32>) -> Self {
        self.custom_events = Some(custom_events);
        self
    }
    ...
    pub fn with_guilds(mut self, guilds: Vec<Guild>) -> Self {
    ...
    pub fn with_guild_locales(mut self, guild_locales: Vec<Locale>) -> Self {
        self.guild_locales = guild_locales;
        self
    }

    pub fn with_guild_members(mut self, guild_members: GuildMembers) -> Self {
        self.guild_members = guild_members;
        self
    }

    pub fn with_interactions(mut self, interactions: Vec<Interaction>) -> Self {
        self.interactions = interactions;
        self
    }

    pub fn with_interactions_locales(mut self, interactions_locales: Vec<Locale>) -> Self {
        self.interactions_locales = interactions_locales;
        self
    }

    pub fn with_removed_guilds(mut self, removed_guilds: i32) -> Self {
        self.removed_guilds = removed_guilds;
        self
    }
    ...
    pub fn with_user_install_count(mut self, user_install_count: i32) -> Self {
        self.user_install_count = Some(user_install_count);
        self
    }

    pub fn with_users_type(mut self, users_type: UserType) -> Self {
        self.users_type = Some(users_type);
        self
    }
}
